...
{
    public class MatchMakingCommunicationsStore
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the IMatchMakingServiceCallback reference for the client
        /// </summary>
        public IMatchMakingServiceCallback Callback { get; set; }
