...
namespace LegendsOfKesmaiSurvival.Services.Business.Maps
{
    ...
    /// and each Tile on the Map should have a TerrainId that corresponds to a specific Terrain in the TerrainPalette.
    /// This allows making broad changes to common Terrains without having to edit each Tile individually.
    /// </summary>
    [Serializable()]
